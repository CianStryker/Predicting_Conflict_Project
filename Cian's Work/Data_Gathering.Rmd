...
All_p_Data <- read_csv("Raw_Data/fifth.csv", col_types = cols(
  .default = col_double(),
  country = col_character(),
  iso2c = col_character(),
...
new_country_list <- unique(All_p_Data$country)
...
write.xlsx(My_countries, "Raw_Data/Yugoslavia.xlsx")

```

```{r}

Final_Data <- read_csv("Raw_Data/Final_Data.csv", col_types = cols(
  .default = col_double(),
  country = col_character(),
  iso2c = col_character(),
  continent = col_character()
