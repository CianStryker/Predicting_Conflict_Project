...
conflict_2 <- conflict %>% 
  ...
  # There's 104 countries that experienced some sort of intrastate conflict between 1960 and 2019
...
# add dummy conflict variable 

fourth_draft <- fourth_draft_data %>%
                mutate(is_conflict = ifelse(type_of_conflict == "NA", 0, 1))

# didn't return 0's for NA values in is_conflict so try again 

fourth_draft$is_conflict[is.na(fourth_draft$is_conflict)] <- 0
  
write_fourth <- write_csv(fourth_draft, path = "Raw_Data_Liz/fourth_draft.csv")
...
>>>>>>> cb56f81e0bf42af602de96de0ea9d28be5483509
