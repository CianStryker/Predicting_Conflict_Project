...
# training_data <- data.frame(rfd[training, ])
...
# Just added the code in for you. Just move it manually into our images folder too 

gtsave(final_check_rf, "Random_Forest_Results.png")
